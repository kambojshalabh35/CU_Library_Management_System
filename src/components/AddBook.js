...
const AddBook = (props) => {
	...
	const { title, author, genre, no_copies, date_published, description } = values;
	...
	return isLoading ? (
		...
		<div className="row">
			<div className="col s12 m8 offset-m2">
				<Link to="/books" className="waves-effect waves-light green accent-4 btn"  style={{margin:"20px 0 20px 0"}}>
							...
							<div className="col s12 m7">
								<form encType="multipart/form-data" onSubmit={handleSubmit}>
									...
									<div className="file-field input-field">
										<div className="btn deep-orange accent-3">
